...
namespace Orleans.Clustering.Redis.Tests
{
    ...
    // </summary>
    public class RedisClusteringTests : MembershipTableTestsBase, IClassFixture<MultiplexerFixture>
    {
        public RedisClusteringTests(ITestOutputHelper output, MultiplexerFixture multiplexerFixture) : base(output, multiplexerFixture, CreateFilters())
        {
